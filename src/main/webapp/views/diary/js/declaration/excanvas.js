...
(function() {
  ...
  contextPrototype.textAlign = function(textAlign) {
	  var textAlignStr = textAlign;
  }
  contextPrototype.textBaseline = function(textBaseline) {
	  var textBaselineStr = textBaseline;
  }
  contextPrototype.fillText = function(textToDraw, x, y) {
	    ...
	    if(this.textAlign == 'left'){
	    	...
	    	leftX = x-(this.measureText(textToDraw).width)/2;
	    }else if(this.textAlign == 'right'){
	    	leftX = x-(this.measureText(textToDraw).width);
	    }else{
	    	leftX = x;
	    }
	    if(this.textBaseline == 'top'){
	    	...
	    	topY = y  - (this.measureText(textToDraw).height)/2;
	    }else if(this.textBaseline == 'bottom'){
	    	topY = y - (this.measureText(textToDraw).height);
	    }else{
	    	topY = y ;
	    }
	    vmlStr.push('<g_vml_:shape style="font:' + this.font + ';',
	                    ...
	                    ' height:' + this.measureText(textToDraw).height + 'px;"',
